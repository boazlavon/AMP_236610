...
def main(planning_env, planner, start, goal, planner_name, extra_text=''):
    ...
    plan = planner.Plan(start, goal, max_iter=1500)
...
if __name__ == "__main__":
    ...
    for planner_name in PLANNER.keys():
        for i in range(5):
            ...
            planner = PLANNER[planner_name](planning_env, goal_bias=0.2, step_size=float('inf'))
            extra_text = 'q2_step{}_i{}'.format('inf', (i + 1))
